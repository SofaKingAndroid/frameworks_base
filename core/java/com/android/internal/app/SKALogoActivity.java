...
public class SKALogoActivity extends Activity {
    Toast mToast;
    ImageView mContent;
    int mCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContent.setImageResource(com.android.internal.R.drawable.skalogo_alt);
        ...
        mContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mToast.show();
                mContent.setImageResource(com.android.internal.R.drawable.skalogo);
            }
        });
